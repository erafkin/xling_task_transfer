...
Code is broken down for training and testing each task (NLI, NER, POS, DP, QA, and morphological inflection) and also for language finetuning. Each script also has a slurm script for running on an HPC. 
