...
The base transformers tested were [`xlm-roberta-base`](https://huggingface.co/FacebookAI/xlm-roberta-base) and [`bert-base-multilingual-cased`](https://huggingface.co/google-bert/bert-base-multilingual-cased). These were finetuned on [Wikipedia data](https://huggingface.co/datasets/wikimedia/wikipedia). Source language was always English, target languages were Spanish, German, Hindi, Chinese, Russian, and French.
